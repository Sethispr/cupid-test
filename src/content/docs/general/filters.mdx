...
<Tabs>
<TabItem label="Filters for `=cdex`">
...
<TabItem label="Filters for `=market`">
...
<TabItem label="Filters for `=cadd` (used for trade)">
...
<TabItem label="Filters for `=select` (used for ID/profile)">
