...
1. Go to the **#channel** you want for **card drop spawns**.

2. Type `=setspawn` in **your card drops channel** (sets the card drops to the channel you used the command in) You will then see a message from the bot saying **"Spawns Redirected to here."** if successful.
