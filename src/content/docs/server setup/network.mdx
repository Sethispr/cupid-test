...
2. Type `=rdnet on`. You will then see a message from the bot saying **"Raid Network enabled"** if successful.

   <Steps>

3. Use `=rd public` in a raid to make it **visible** in the **network channel**.
